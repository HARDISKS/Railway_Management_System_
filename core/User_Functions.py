...
def Show_Trains():
    ...
    from_station = input("Enter your station code:")
    to_station = input("Enter the destination station code:")

    args = [from_station, to_station, trains]
    trains = cur.callproc('Check_Fare', args)
